package main.javacore.ZZBjdbc.db;

import main.javacore.ZZBjdbc.classes.Comprador;
import main.javacore.ZZBjdbc.classes.MyRowSetListener;
import main.javacore.ZZBjdbc.conn.ConexaoFactory;
...
//            jrs.setString(2, comprador.getNome());
    ...
    public static void updateRowSetCached(Comprador comprador) {
        ...
        try {
            ...
            crs.execute();
            crs.next();
            crs.updateString("nome", "Elivelton");
            crs.updateRow();
            crs.acceptChanges();
            System.out.println("Registro atualizado com sucesso");
        } catch (SQLException e) {
